...
const updates = [
  {
    ...
    text:
      "The new VEXDOU digital experience is now live.",
  },
  {
    date: "2026",
    title: "Building Something New",
    text:
      "More projects, ideas and digital experiences are coming.",
  },
  {
    date: "2026",
    title: "The Journey Continues",
    text:
      "Creating, learning and building one project at a time.",
  },
];
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#030406] text-white">
        ...
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          >
            ...
            <div className="hidden sm:block">
              ...
              <div className="text-sm font-black tracking-[4px]">
                VEXDOU
              </div>
      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-5 pt-20 text-center">
          ...
          <p className="mx-auto mt-7 max-w-xl text-sm leading-7 text-white/50 sm:text-base">
            Building digital experiences, creative projects
            and technology that turn ideas into reality.
          </p>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[.8fr_1.2fr]">
            ...
            <div>
              ...
              <p className="mt-7 max-w-2xl text-sm leading-8 text-white/45 sm:text-base">
                I'm VEXDOU. I enjoy technology, creating digital
                products, experimenting with new ideas and building
                things that people can actually use.
              </p>

              <p className="mt-5 max-w-2xl text-sm leading-8 text-white/35">
                This platform is my personal digital space where
                you can discover my projects, social platforms,
                updates and the things I'm currently working on.
              </p>
            ...
            {socials.map((social, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute right-0 top-0 h-28 w-28 rounded-full bg-violet-500/10 blur-3xl opacity-0 transition group-hover:opacity-100" />
      ...
      <section
        id="work"
        className="px-5 py-28 lg:px-8 lg:py-40"
      >
        ...
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[35px] border border-white/10 bg-gradient-to-br from-violet-950/40 via-white/[.03] to-cyan-950/30 px-6 py-20 text-center sm:px-12">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-lg text-sm leading-7 text-white/40">
              ...
              stay connected with what I'm building next.
            </p>
